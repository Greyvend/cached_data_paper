...
\author{Sergey~Vladimirovich~Mosin,
        Sergey~Vladimirovich~Zykin % <-this % stops a space
...
work, we propose the usage of logical formulas' domain subsets, called Truth
spaces, while querying a Database.
