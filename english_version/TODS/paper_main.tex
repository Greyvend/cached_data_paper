...
% Page heads
\markboth{S.~V. Mosin, S.~V. Zykin}{Truth space method for caching database
queries}

% Title portion
\title{Truth space method for caching database queries}
\author{SERGEY V. MOSIN
\affil{Sobolev Institute of Mathematics of the Siberian Branch
...
\terms{Caching, Optimization}

\keywords{Relational database, Truth space, Intermediate Data View, Logical
formula}

\acmformat{Sergey V. Mosin and Sergey V. Zykin, 2014. Truth space method for
